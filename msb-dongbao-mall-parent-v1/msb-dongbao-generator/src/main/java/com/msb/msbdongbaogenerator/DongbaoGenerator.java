...
public class DongbaoGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir("D:\\code0612\\msb-dongbao-mall\\msb-dongbao-mall-parent-v1\\msb-dongbao-service\\msb-dongbao-ums1\\src\\main\\java");
		gc.setAuthor("晁鹏飞");
		...
		dsc.setUrl("jdbc:mysql://192.168.113.128:3306/msb_dongbao_test?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
